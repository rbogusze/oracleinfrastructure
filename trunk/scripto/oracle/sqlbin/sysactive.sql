...
and USERNAME in ('SYS', 'SYSTEM','DBSNMP','SYSMAN')
and SQL_HASH_VALUE not in ('847677949')
;
...
and ses.USERNAME in ('SYS', 'SYSTEM')
and ses.SQL_HASH_VALUE not in ('847677949')
;
...
and s.USERNAME in ('SYS', 'SYSTEM','DBSNMP','SYSMAN')
and s.SQL_HASH_VALUE not in ('847677949')
and s.status = 'ACTIVE';
