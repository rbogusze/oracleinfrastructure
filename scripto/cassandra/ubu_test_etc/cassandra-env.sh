...
JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname=10.0.0.101"
#
# see
...
JVM_OPTS="$JVM_OPTS -javaagent:/home/cassandra/cassandra-prometheus/jmx_prometheus_javaagent-0.9.jar=7070:/home/cassandra/cassandra-prometheus/cassandra.yml"
