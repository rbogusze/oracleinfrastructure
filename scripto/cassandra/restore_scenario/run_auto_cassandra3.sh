...
run_command_e "sleep 60"
run_command_e "docker-compose -f docker_compose.yml up -d"
run_command_e "sleep 60"
run_command_e "docker exec cassandra_node_A1 nodetool status"
run_command_e "cd /root/scripto/cassandra/restore_scenario"
run_command_e "./restore_scenario.sh --docker_list cassandra_node_A1,cassandra_node_A2,cassandra_node_A3 --cqlshrc /root/.cassandra/cqlshrcnode_A1 --create_phase_file 01_create_simple.cql --destroy_phase_file 01_destroy_simple.cql"
