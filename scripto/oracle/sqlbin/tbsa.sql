...
select tablespace_name, round(sum(blocks*8192/1024/1024)) UsedMB, round(sum(maxblocks*8192/1024/1024)) MaxMB, round(sum(blocks)*100/sum(maxblocks)) rate from dba_data_files group by tablespace_name order by rate;
