...
JVM_OPTS="$JVM_OPTS -javaagent:/usr/local/jolokia/jolokia.jar=host=127.0.0.1,port=8778"
...
JVM_OPTS="$JVM_OPTS -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Djava.rmi.server.hostname=10.122.145.1"
