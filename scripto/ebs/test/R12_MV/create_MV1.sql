CREATE MATERIALIZED VIEW "APPS"."TEST_PO_LINE_LOCATIONS_ALL_MV" ("LINE_LOCATION_ID", "PO_HEADER_ID", "PO_LINE_ID", "PO_RELEASE_ID", "SHIPMENT_NUM", "QUANTITY", "QUANTITY_RECEIVED", "QUANTITY_BILLED", "QUANTITY_ACCEPTED", "CLOSED_CODE", "LAST_UPDATE_DATE")
